sap.ui.define([
		...
		return BaseController.extend("opensap.manageproducts.controller.Worklist", {
			...
			onPress : function (oEvent) {
				...
				//like onAdd we now rout to delete
			onDelete: function(oEvent) {
				var oTable = oEvent.getSource(),
                oModel = this.getModel(),
                pName = oTable.getBindingContext().getObject().Name;
                var sId = oTable.getBindingContext().sPath;
                oModel.remove(oTable.getBindingContext().sPath);
                
                var sMessage = this.getResourceBundle().getText("Product with name: " + pName + " deleted!");
